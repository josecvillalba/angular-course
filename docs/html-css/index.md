...
| --- | --- | --- |
| \<!-- --> | Comment |
| \<!DOCTYPE> | Document type | \<!DOCTYPE html> defines that this document is an HTML5 document
| \<a>  | Hyperlink | href, hreflang, media, ping, rel, target, type
| \<abbr> | Abbreviation | 
| \<address> | Address element | 
| \<area> | Area inside an image map | alt, coords, href, hreflang, media, ping, rel, shape, target, type 
| \<article>  | Article | cite, pubdate
| \<aside> | Content aside from the page content | 
| \<audio> | Sound content | autobuffer, autoplay, controls, src 
| \<b> | Bold text | 
| \<base> | Base URL for all the links in the page | href, target 
| \<bdo> | Direction of text display | dir 
| \<blockquote> | Long quotation | cite
| \<body> | Body element | 
| \<br> | Single line break | 
| \<button> | Push button | autofocus, disabled, form, formaction, formenc-type, formmethod, formnovalidate, formtarget, name, type, value
| \<canvas> | Graphics | height, width
| \<caption> | Table caption | 
| \<cite> | Citation | 
| \<code> | Computer code text | autobuffer, autoplay, controls, src 
| \<col> | Attributes for table columns | 
| \<colgroup> | Groups of table columns | 
| \<command> | Command button | checked, disabled, icon, label, radiogroup, type 
...
| \<hr> | Horizontal rule | 
| \<html> | Html document | manifest, xmlns
| \<i> | Italic text | 
...
| \<li> | List item | value
| \<link> | Resource reference | href, hreflang, media, rel, sizes, type
| \<map> | Image map | name
| \<mark> | Marked text | 
| \<menu> | Menu list | label, type 
| \<meta> | Meta information | charset, content, http-equiv, name
...
| \<ol> | Ordered list | reversed, start
...
| \<progress> | Progress of a task of any kind | max, value
...
| \<strong> | Strong text | 
| \<style> | Style definition | type, media, scope 
